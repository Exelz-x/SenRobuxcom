...
- Harga pas
- Status For Sale
- Inventory/game kamu public.`
        );
        return;
      }

      // TODO: nanti simpan data.gamePass ke DB bersama orderId
      router.push(`/checkout/${orderId || "test"}`);
    } catch (e) {
      console.error(e);
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
        ...
        <section className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm space-y-2">
          ...
          <p>
            ...
            <span className="font-semibold text-emerald-400">
              {requiredPrice ? requiredPrice.toLocaleString("id-ID") : "-"} Robux
            </span>
          </p>
          <p className="text-xs text-gray-400">
            Catatan: Roblox mengambil pajak sekitar 30% dari penjualan gamepass. Karena itu,
            untuk menerima {robux.toLocaleString("id-ID")} Robux, kamu perlu membuat gamepass
            dengan harga sekitar {requiredPrice.toLocaleString("id-ID")} Robux.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="aspect-video rounded-2xl overflow-hidden border border-white/10 bg-black">
            {/* Ganti src di bawah dengan link YouTube tutorial yang kamu suka */}
            <iframe
        ...
        <section className="space-y-3 text-sm text-gray-200">
          ...
          <ol className="list-decimal list-inside space-y-1">
            <li>Buka Roblox Creator di tombol &quot;Buat Gamepass&quot; di bawah.</li>
            <li>Pilih game yang kamu miliki (atau buat game baru jika belum ada).</li>
            <li>Buat gamepass baru dan isi harganya menjadi{" "}
              <span className="font-semibold text-emerald-400">
                {requiredPrice ? requiredPrice.toLocaleString("id-ID") : "-"} Robux
              </span>.
            </li>
            <li>Pastikan gamepass di-set &quot;For Sale&quot; dan sudah di-publish.</li>
            <li>Setelah selesai, klik tombol &quot;Sudah membuat gamepass&quot; di bawah ini.</li>
          </ol>
        </section>
